...
//aquí declaramos la const Movie y le pasamos la dir del modelo que es el que debe seguir la seed
const Movie = require('../models/Movie');
//declaramos el nombre de la base de datos
const dbName = 'lab-express-cinema';
//conectamos a mongoose y le pasamos un template con la variable de la base de datos.
...
//con esto nos aseguramos de borrar lo que pudiera haberse creado en la base de datos para asegurar q solo queden las colecciones que indicamos debajo
  Movie.collection.drop();

  //Aquí creamos la base de datos con estas colecciones.Cuando la iniciamos con node debemos pasarle la dir de  la seed.
